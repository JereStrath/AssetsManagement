        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              TextField(controller: manufacturerController, decoration: const InputDecoration(labelText: "Condition")),
              ...
              TextField(controller: assignedUserController, decoration: const InputDecoration(labelText: "Assigned User")),
              TextField(controller: warrantyController, decoration: const InputDecoration(labelText: "Warranty Expiry Date")),
              TextField(controller: notesController, decoration: const InputDecoration(labelText: "Notes")),
              TextField(controller: customField1Controller, decoration: const InputDecoration(labelText: "Custom Field 1")),
